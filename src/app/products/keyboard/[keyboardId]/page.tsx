...
export default function KeyboardDetails({
  ...
  const { colorMode, setColorMode } = useMainContext();
  ...
  return (
    <MainContext.Provider value={{ colorMode, setColorMode }}>
      <div className="bg-white">
        <div className="pt-6">
          ...
          {/* <!-- Image gallery --> */}
          {/* <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8 justify-end"> */}
          <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-4xl lg:grid-cols-1 lg:gap-x-8 lg:px-8 justify-end">
